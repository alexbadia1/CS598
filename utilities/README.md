These scripts are all designed to work on igraph exports of provenance graphs. There are several vertex and edge attributes that must be present in order for them to work:
